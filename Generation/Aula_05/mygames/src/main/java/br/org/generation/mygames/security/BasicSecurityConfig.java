package br.org.generation.mygames.security;
...
public class BasicSecurityConfig extends WebSecurityConfigurerAdapter {
	 ...
	 * implementada na Classe UserDetailsServiceImpl que fará o acesso ao nosso 
	 * Banco de dados para recuperar os dados do usuário.
	 */
	...
	public PasswordEncoder passwordEncoder() {
		...
		/*A annotation @Bean transforma a instância retornada pelo
		 *  método como um objeto gerenciado pelo Spring, desta forma,
		 *   ele pode ser injetado em qualquerclassea qualquer momento 
		 *   que você precisar sem a necessidade de usar a annotation @Autowired
		 * 
